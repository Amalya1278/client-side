...
import { InputUser, IUser } from "../helpers/types";

export const AddUser = () => {
    const {register,handleSubmit,formState:{errors},reset}=useForm<InputUser>()
    const handleAdd=async(data:InputUser)=>{
            ...
            <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
                ...
                className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                        {...register("name",{required:"please fill the input"})}
                            type="text"
                            id="name"
                            name="name"
                    ...
                    <div>
                        ...
                        <input
                        {...register("surname",{required:"please fill the input"})}
                    ...
                    <div>
                        ...
                        <input
                        {...register("age",{required:"please fill the input"})}
                            type="number"
                            id="age"
                            name="age"
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    ...
                    <div>
                        ...
                        <input
                        {...register("salary",{required:"please fill the input"})}
                            type="number"
                            id="salary"
                            name="salary"
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
